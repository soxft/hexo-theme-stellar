...
$(function () {
  ...
  for (var i = 0; i < els.length; i++) {
    ...
    cfg.el = el;
    cfg.api = api;
    cfg.avatar = 'https://static.iirose.cn/hexo/stellar/placeholder/link/8f277b4ee0ecd.svg';
    cfg.screenshot = 'https://static.iirose.cn/hexo/stellar/placeholder/cover/76b86c0226ffd.svg';
    sitesjs.layout(cfg);
  }
});
